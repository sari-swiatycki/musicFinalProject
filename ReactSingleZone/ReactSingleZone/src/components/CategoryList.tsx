...
//                 textTransform: 'none',
//                 fontWeight: 'bold',
//                 color: selectedCategory === category.id ? '#fff' : '#bbb',
//                 backgroundColor: selectedCategory === category.id ? '#1DB954' : '#212121',
//                 borderColor: '#333',
//                 '&:hover': {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ mt: 4, p: 2, backgroundColor: 'rgba(41, 182, 246, 0.1)', borderRadius: 2 }}>
        ...
        >
          Each category features handpicked selections from our extensive music library.
          Click any genre to start your musical journey.
        </Typography>
      </Box>
