...
//           {[
//             { title: "יצירת פלייליסט", desc: "סדר את השירים האהובים עליך" },
//             { title: "האזנה", desc: "נגן שירים מכל מקום" },
//             { title: "הורדה", desc: "שמור מוזיקה להאזנה אופליין" },
//           ].map((feature, index) => (
//             <Box
//               key={index}
//               sx={{
...
// import { fetchAllSongs, fetchLatestSongs } from "../Slices/actionSongSlice";
...
//   useEffect(() => {
//     // לקרוא לפעולה של fetchAllSongs כאשר הקומפוננטה נטענת
//     dispatch(fetchAllSongs());
//   }, [dispatch]);

//   return (
//     <Box sx={{ backgroundColor: "#000", minHeight: "100vh", color: "white", pb: 6 }}>
//       <Header />
//       <Container maxWidth="md" sx={{ textAlign: "center", pt: 12, pb: 4 }}>
//         <motion.div
...
//             desc: "Organize your favorite songs",
//           }, {
//             title: "Listen Anywhere",
//             desc: "Stream music from any device",
//           }, {
//             title: "Download & Go",
//             desc: "Save music for offline listening",
//           }].map((feature, index) => (
...
//           {["The Evolution of Jazz", "Top 10 Rock Albums of All Time", "How Streaming Changed the Industry"].map((article, index) => (
//             <Grid item xs={12} sm={4} key={index}>
//               <FeatureCard>
...
//   cursor: "pointer",
//   '&:hover': {
//     transform: "scale(1.1)",  // הגדלת הכרטיסים בעת מעבר עכבר
//     boxShadow: "0px 4px 20px rgba(255, 255, 255, 0.2)"
//   },
// }));
...
//   // פונקציה לשליפת תמונת עטיפת השיר
...
//   // ביצוע reverse על המערך ולקיחת שלושת השירים הראשונים
//   const topThreeSongs = songs
//     .slice()  // יצירת עותק של המערך
//     .reverse() // הפיכת המערך
//     .slice(0, 3); // בחירת שלושת השירים הראשונים אחרי ה-reverse

//   // שימוש ב- useEffect כדי לשלוף את תמונות העטיפה של השירים
//   useEffect(() => {
//     const fetchCoverArts = async () => {
//       const newCovers = {};
//       for (const song of topThreeSongs) {
//         if (song.audioUrl) {
...
//       {/* כותרת מגניבה לפני הצגת השירים החדשים */}
//       <Container maxWidth="lg" sx={{ mt: 6 }}>
//         <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
//           <Typography variant="h3" fontWeight="bold" color="white" sx={{ mb: 4 ,justifyContent:"center"}}>
//             New Hits You Can't Miss!


            
//           </Typography>
//         </motion.div>
//         {/* הצגת שלושת השירים הראשונים אחרי ה-reverse */}
//         <Grid container spacing={5} justifyContent="center">
//           {topThreeSongs.map((song, index) => (
//             <Grid item xs={12} sm={4} key={index}>
//               <FeatureCard sx={{ maxWidth: 400, minWidth: 350 }}>
//                 <CardContent sx={{ textAlign: "center", p: 3 }}>
//                   <CardMedia
//                     component="img"
//                     height="250"
...
//       {/* ארבעה מלבנים שמתארים את הפונקציות של האתר */}
//       <Container maxWidth="lg" sx={{ mt: 6 }}>
//         <Grid container spacing={3} justifyContent="center">
//           <Grid item xs={12} sm={6} md={3}>
//             <InfoCard>
//               <Typography variant="h6" fontWeight="bold">Upload Songs</Typography>
//               <Typography variant="body2" color="gray">Easily upload your favorite songs to share with others.</Typography>
//             </InfoCard>
//           </Grid>
//           <Grid item xs={12} sm={6} md={3}>
//             <InfoCard>
//               <Typography variant="h6" fontWeight="bold">Save Songs</Typography>
//               <Typography variant="body2" color="gray">Save your favorite songs to listen to them later.</Typography>
//             </InfoCard>
//           </Grid>
//           <Grid item xs={12} sm={6} md={3}>
//             <InfoCard>
//               <Typography variant="h6" fontWeight="bold">Update Songs</Typography>
//               <Typography variant="body2" color="gray">Update the song details and metadata when needed.</Typography>
//             </InfoCard>
//           </Grid>
//           <Grid item xs={12} sm={6} md={3}>
//             <InfoCard>
//               <Typography variant="h6" fontWeight="bold">Create Playlists</Typography>
//               <Typography variant="body2" color="gray">Create and manage your own music playlists.</Typography>
//             </InfoCard>
//           </Grid>
//         </Grid>
//       </Container>
